...
namespace Google.Cloud.Compute.Codegen.Prototype
{
    ...
    public class CodegenConfig
    {
        ...
        public string ApiarySourcePath => @"ApiarySource/Google.Apis.Compute.v1.cs";
        public string ApiaryResourceNamespace => "Google.Apis.Compute.v1";
        public string ApiaryResourceSuffix => "Resource";
        public string ApiaryDataNamespace => "Google.Apis.Compute.v1.Data";
        public string ApiaryRequestBaseTypeIdentifier => "ComputeBaseServiceRequest";
        ...
        public string OutputSolutionFilePath => @"../../../../Google.Cloud.Compute.Protoype.sln";
        public string OutputProjectName => "Google.Cloud.Compute.Prototype";
        public string OutputResourcesNamespace => "Google.Cloud.Compute.Prototype";
        public string OutputResourcesFileName => "Resources.cs";
        public string OutputClientNamespace => "Google.Cloud.Compute.Prototype";
        public string OutputClientFileName => $"{ApiName}Client.Resources.cs";
    }
}
