...
namespace Google.Cloud.BigQuery.V2
{
    public abstract partial class BigQueryClient
    {
        ...
        #region PatchRoutine (autogenerated - do not edit manually)
        /// <summary>
        /// Patches the specified routine within this client's project with fields in the given resource.
        /// This method just creates a <see cref="RoutineReference"/> and delegates to <see cref="PatchRoutine(RoutineReference, Routine, PatchRoutineOptions)"/>.
        /// </summary>
        /// <remarks>
        /// If the resource contains an ETag, it is used for optimistic concurrency validation.
        /// </remarks>
        /// <param name="datasetId">The dataset ID. Must not be null.</param>
        /// <param name="routineId">The routine ID. Must not be null.</param>
        /// <param name="resource">The routine resource representation to use for the patch. Only fields present in the resource will be updated. If this routine's <see cref="Routine.RoutineReference"/> is specified, then it must be the same as the one obtained from the other parameters, else it will be set to the one obtained from the other parameters.</param>
        /// <param name="options">The options for the operation. May be null, in which case defaults will be supplied.</param>
        /// <returns>The updated routine.</returns>
        public virtual BigQueryRoutine PatchRoutine(string datasetId, string routineId, Routine resource, PatchRoutineOptions options = null) =>
            PatchRoutine(GetRoutineReference(datasetId, routineId), resource, options);

        /// <summary>
        /// Patches the specified routine with fields in the given resource.
        /// This method just creates a <see cref="RoutineReference"/> and delegates to <see cref="PatchRoutine(RoutineReference, Routine, PatchRoutineOptions)"/>.
        /// </summary>
        /// <remarks>
        /// If the resource contains an ETag, it is used for optimistic concurrency validation.
        ...
        /// <param name="options">The options for the operation. May be null, in which case defaults will be supplied.</param>
        /// <returns>The updated routine.</returns>
        public virtual BigQueryRoutine PatchRoutine(string projectId, string datasetId, string routineId, Routine resource, PatchRoutineOptions options = null) =>
            PatchRoutine(GetRoutineReference(projectId, datasetId, routineId), resource, options);
        ...
        /// <param name="options">The options for the operation. May be null, in which case defaults will be supplied.</param>
        /// <returns>The updated routine.</returns>
        public virtual BigQueryRoutine PatchRoutine(RoutineReference routineReference, Routine resource, PatchRoutineOptions options = null) =>
            throw new NotImplementedException();

        /// <summary>
        /// Asynchronously patches the specified routine within this client's project with fields in the given resource.
        /// This method just creates a <see cref="RoutineReference"/> and delegates to <see cref="PatchRoutineAsync(RoutineReference, Routine, PatchRoutineOptions, CancellationToken)"/>.
        /// </summary>
        /// <remarks>
        /// If the resource contains an ETag, it is used for optimistic concurrency validation.
        /// </remarks>
        ...
        /// <returns>A task representing the asynchronous operation. When complete, the result is
        /// the updated routine.</returns>
        public virtual Task<BigQueryRoutine> PatchRoutineAsync(string datasetId, string routineId, Routine resource, PatchRoutineOptions options = null, CancellationToken cancellationToken = default) =>
            PatchRoutineAsync(GetRoutineReference(datasetId, routineId), resource, options, cancellationToken);

        /// <summary>
        /// Asynchronously patches the specified routine with fields in the given resource.
        /// This method just creates a <see cref="RoutineReference"/> and delegates to <see cref="PatchRoutineAsync(RoutineReference, Routine, PatchRoutineOptions, CancellationToken)"/>.
        /// </summary>
        /// <remarks>
        /// If the resource contains an ETag, it is used for optimistic concurrency validation.
        ...
        /// <returns>A task representing the asynchronous operation. When complete, the result is
        /// the updated routine.</returns>
        public virtual Task<BigQueryRoutine> PatchRoutineAsync(string projectId, string datasetId, string routineId, Routine resource, PatchRoutineOptions options = null, CancellationToken cancellationToken = default) =>
            PatchRoutineAsync(GetRoutineReference(projectId, datasetId, routineId), resource, options, cancellationToken);
        ...
        /// <returns>A task representing the asynchronous operation. When complete, the result is
        /// the updated routine.</returns>
        public virtual Task<BigQueryRoutine> PatchRoutineAsync(RoutineReference routineReference, Routine resource, PatchRoutineOptions options = null, CancellationToken cancellationToken = default) =>
            throw new NotImplementedException();
        #endregion
    }
}
